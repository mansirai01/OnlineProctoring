...
def create_category_index(label_path='coco models/tflite mobnetv1 ssd/coco_ssd_mobilenet/labelmap.txt'):
    """
...
interpreter = tf.lite.Interpreter(model_path="coco models/tflite mobnetv1 ssd/coco_ssd_mobilenet/detect.tflite")
