...
modelFile = "face_detection/models/res10_300x300_ssd_iter_140000.caffemodel"
configFile = "face_detection/models/deploy.prototxt.txt"
net = cv2.dnn.readNetFromCaffe(configFile, modelFile)
classifier2 = cv2.CascadeClassifier('face_detection/models/haarcascade_frontalface2.xml')

cap = cv2.VideoCapture('face_detection/light.gif')
